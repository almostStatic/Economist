...
module.exports = {
	...
	async run(client, message, args) {
		...
		if (Object.keys(data).length > 10 && (message.author.id != client.config.owner)) return message.channel.send(`You may not have more than 10 instantaneous replacers; please remove one before continuing.`);
